...
/*   Updated: 2025/02/08 18:39:43 by jesuserr         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
typedef struct s_encrypt_args
{
	...
	uint8_t		plain_block[BLOCK_LENGTH];
	uint8_t		cipher_block[BLOCK_LENGTH];
}	t_encrypt_args;
...
// Tables for expansion permutation, S-boxes and P permutation
static const uint8_t	g_exp_table[48] = {
...
static const uint8_t	g_s_boxes[8][4][16] = {
{
